...
namespace murasanca
{
    ...
    /// Editor
    /// </summary>
    public class E:UnityEngine.MonoBehaviour
    {
        /// <summary>
        /// Database Reference
        /// </summary>
        private static Firebase.Database.DatabaseReference
            pDR,    // p: Place.
        ...
        /// <summary>
        /// JavaScript Object Notation to Desktop
        /// </summary>
        [UnityEditor.MenuItem("Murat Sancak/JSON 2 Desktop",false,1)]
        private static void JSON2D()
        {
        ...
        /// Place to Zero
        /// </summary>
        [UnityEditor.MenuItem("Murat Sancak/Place 2 Zero",false,1)]
        private static void P2Z()
        {
            _=(pDR=Firebase.Database.FirebaseDatabase.DefaultInstance.RootReference.Child("Place")).Child("62 62").SetValueAsync("1 .25 0:Murat Sancak");_=(pVCDR=Firebase.Database.FirebaseDatabase.DefaultInstance.RootReference.Child("P")).SetValueAsync("62 62");
        ...
        /// <summary>
        /// Place's Children Count
        /// </summary>
        [UnityEditor.MenuItem("Murat Sancak/Place's Children Count",false,1)]
        private static void PCC()
            =>
            _=Firebase.Database.FirebaseDatabase.DefaultInstance.RootReference.Child("Place").GetValueAsync().ContinueWithOnMainThread
            (
                t // t: Task.
                =>
                {
                    if(t.IsCompleted)
                        UnityEngine.Debug.LogWarning(string.Concat("Place's Children Count:\t",t.Result.ChildrenCount));
                }
            );
    }
}
